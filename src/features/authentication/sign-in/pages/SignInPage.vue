      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 order-2 order-lg-1">
          <div class="form-image">
            <v-img src="/assets/images/AppLogo.webp" alt="sign-in-image" />
          </div>
        </div>
        <div class="col-lg-6 col-md-12 order-1 order-lg-2">
          <div class="form-content">
            <div class="logo">
              <v-img src="/assets/images/AppLogo.webp" alt="logo" />
              <v-img
                  src="/assets/images/AppLogo.webp"
                  class="d-none"
                  alt="logo"
              />
            </div>
            ...
            >
              <div>
                <button type="button">
                  <v-img src="/assets/images/AppLogo.webp" alt="google" />
                </button>
              </div>
              <div>
                <button type="button">
              ...
              <div>
                <button type="button">
                  <v-img src="/assets/images/AppLogo.webp" alt="apple" />
                </button>
              </div>
            </div>
            <form>
