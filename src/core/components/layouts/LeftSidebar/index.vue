  ...
  >
    <div class="logo bg-white">
      <RouterLink to="/dashboard" class="d-flex align-items-center">
        ...
        <span class="fw-bold text-black position-relative " style="font-size: 18px">
    ...
    <div class="virtual-scroll">
      <div class="sidebar-inner">
        <div class="sidebar-menu">
          ...
          <AccordionSlot>
            <span class="sub-title">القائمة الرئيسية</span>
            <RouterLink to="/dashboard/main" class="sidebar-menu-link">
              <span class="material-symbols-outlined">
                dashboard
              </span>
              <span class="title">الرئيسية</span>
            </RouterLink>
            <RouterLink to="/dashboard/demos" class="sidebar-menu-link">
              <span class="material-symbols-outlined">
                dashboard
              </span>
              <span class="title">أمثله</span>
            </RouterLink>

            <RouterLink to="/dashboard/test" class="sidebar-menu-link">
              <span class="material-symbols-outlined">
                dashboard
              </span>
              <span class="title">aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</span>
            </RouterLink>
