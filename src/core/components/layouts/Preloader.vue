  ...
  <div class="preloader" id="preloader">
    <div class="preloader">
      <div class="waviy position-relative">
        <v-row>
          <v-col cols="12" md="12" class="d-flex align-items-center justify-content-center">
            <v-img src="/assets/images/AppLogo.webp" alt="logo-icon" style="width: 100px; height: 100px" />
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12" md="12" class="d-flex align-items-center justify-content-center">
        ...
        <v-row>
          <v-col cols="12" md="12" class="d-flex align-items-center justify-content-center">
            <v-progress-linear indeterminate size="35"  color="primary" />
          </v-col>
        </v-row>
      </div>
    </div>
